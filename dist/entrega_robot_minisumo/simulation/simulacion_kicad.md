...
El esquematico esta en `hardware/kicad/robot_minisumo.kicad_sch`. Si `kicad-cli` esta disponible, ejecutar ERC y exportar PDF/SVG desde `hardware/kicad/exports/`.
