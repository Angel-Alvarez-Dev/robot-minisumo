...
void setup() {
  ...
  detener();
  Serial.println("Prueba SG90 D9/D10 sin libreria Servo.");
  Serial.println("Calibracion confirmada: D9 1700 us avanza y 1300 us retrocede; D10 acompana invertido por montaje.");
}
